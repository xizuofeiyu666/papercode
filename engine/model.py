...
class Model(torch.nn.Module):
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        # 传递显式参数给 predictor
        # 检查 predictor 是否支持多模态API（YOLOMMPredictor 或 RTDETRMMPredictor）
        is_multimodal_predictor = hasattr(self.predictor, 'predictor') or 'MM' in self.predictor.__class__.__name__
